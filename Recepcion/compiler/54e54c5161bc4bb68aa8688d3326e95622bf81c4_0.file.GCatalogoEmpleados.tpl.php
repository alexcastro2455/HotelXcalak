<?php
/* Smarty version 3.1.31, created on 2017-10-05 12:43:13
  from "C:\xampp\htdocs\HotelXcalak\Recepcion\styles\templates\catalogos\GCatalogoEmpleados.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_59d60cc1001ec1_58516802',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '54e54c5161bc4bb68aa8688d3326e95622bf81c4' => 
    array (
      0 => 'C:\\xampp\\htdocs\\HotelXcalak\\Recepcion\\styles\\templates\\catalogos\\GCatalogoEmpleados.tpl',
      1 => 1507200051,
      2 => 'file',
    ),
  ),
...
function content_59d60cc1001ec1_58516802 (Smarty_Internal_Template $_smarty_tpl) {
     	...
     	function GuardarDatos(form){
            ...
            if(connect.readyState == 4 && connect.status == 200){
                ...
                if(parseInt(connect.responseText) == 1){
                  ...
                  imprimirMensaje('class="alert alert-success"', "Registro correcto.");

                }else if (parseInt(connect.responseText) == 2){
                  //conectado con éxito, se redirecciona
                  imprimirMensaje('class="alert alert-success"', "No se pudo registrar.");
              }
                else if(parseInt(connect.responseText) == 3){
                	imprimirMensaje('class="alert alert-danger"', "El correo ya existe.");
                }
                /////////////////////////////////////////
                /////////////////////////////////////////
                /////////////////////////////////////////
